    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $this->session->userdata('nama') ?></strong></span></span></a>
                    </div>
                ...
                <li <?php echo $active == 'kuesioner' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('kuesioner')?>"><i class="fa fa-pencil-square"></i> <span class="nav-label">Kuesioner</span></a>
                </li>
                <li <?php echo $active == 'Hasil Rekomendasi' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('hasil_rekomendasi')?>"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Hasil Rekomendasi</span></a>
                </li>
