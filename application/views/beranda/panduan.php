            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a class="page-scroll" href="<?php echo site_url('beranda/panduan'); ?>" style="color:#1ab394;">Panduan</a></li>
...
<section id="panduan" class="timeline" style="margin-top: 0">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="navy-line"></div>
                <h1>Panduan Pengguna</h1>
                <p>Berikut merupakan langkah-langkah dalam menggunakan sistem ini:</p>
            </div>
        </div>
                ...
                <div id="vertical-timeline" class="vertical-container light-timeline center-orientation">
                    <div class="vertical-timeline-block">
                        ...
                        <div class="vertical-timeline-content">
                            <h2>Memilih Kecamatan</h2>
                            <p>Pada langkah ini, pengguna perlu memilih kecamatan tempat tinggalnya untuk mengetahui TK mana yang direkomendasikan di daerah tersebut.</p>
                            <span class="vertical-date"> Langkah 1 <br/></span>
                        </div>
                    </div>
                    ...
                    <div class="vertical-timeline-block">
                        ...
                        <div class="vertical-timeline-content">
                            <h2>Menentukan Kriteria TK</h2>
                            <p>Pada langkah ini, pengguna perlu menentukan kriteria TK yang diinginkan.</p>
                            <span class="vertical-date"> Langkah 2 </span>
                        </div>
                    </div>
                    ...
                    <div class="vertical-timeline-block">
                        ...
                        <div class="vertical-timeline-content">
                            <h2>Melihat Hasil Rekomendasi</h2>
                            <p>Pada langkah ini, pengguna bisa melihat hasil rekomendasi TK terbaik di daerahnya.</p>
                            <span class="vertical-date"> Langkah 3 </span>
                        </div>
                    </div>
